...
> This release redesigns the desktop UI and status presentation, while improving training configuration with route caching, lightweight navigation feedback, and efficient parameter animations.
