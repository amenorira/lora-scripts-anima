...
{"key": "network_dim", "type": "number", "default": 32, "section": "network", "desc_key": "field.network_dim", "hint_key": "field.network_dimHint", "target": "toml", "min": 1, "max": 256, "step": 1},
{"key": "network_alpha", "type": "number", "default": 32, "section": "network", "desc_key": "field.network_alpha", "hint_key": "field.network_alphaHint", "target": "toml", "min": 1},
...
{"key": "mixed_precision", "type": "select", "default": "bf16", "section": "training", "desc_key": "field.mixed_precision", "hint_key": "field.mixed_precisionHint", "target": "toml", "options": [{"v": "bf16", "l": "bf16", "dk": "opt.mixed_precision_bf16"}, {"v": "fp16", "l": "fp16", "dk": "opt.mixed_precision_fp16"}, {"v": "no", "l": "no", "dk": "opt.mixed_precision_no"}]},
    ...
    {"key": "logit_mean", "type": "number", "default": 0.0, "section": "training", "desc_key": "field.logit_mean", "hint_key": "field.logit_meanHint", "target": "toml", "step": 0.01, "group": "anima", "show_if": [{"key": "weighting_scheme", "eq": "logit_normal"}, {"key": "timestep_sampling", "eq": "sigma"}], "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "logit-normal"},
    {"key": "logit_std", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.logit_std", "hint_key": "field.logit_stdHint", "target": "toml", "step": 0.01, "group": "anima", "show_if": [{"key": "weighting_scheme", "eq": "logit_normal"}, {"key": "timestep_sampling", "eq": "sigma"}], "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "logit-normal"},
    {"key": "mode_scale", "type": "number", "default": 1.29, "section": "training", "desc_key": "field.mode_scale", "hint_key": "field.mode_scaleHint", "target": "toml", "step": 0.01, "group": "anima", "show_if": [{"key": "weighting_scheme", "eq": "mode"}, {"key": "timestep_sampling", "eq": "sigma"}], "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "mode"},
...
{"key": "learning_rate", "type": "text", "default": "1e-4", "section": "optimizer", "desc_key": "field.learning_rate", "target": "toml", "doc_slug": "optimizers", "doc_anchor": "learning-rate", "auto_value": [{"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": "1.0"}, {"watch": "optimizer_type", "when": PRODIGYPLUS_OPTIMIZER_TYPE, "set": "1.0"}, {"watch": {"optimizer_type": "AdamW", "model_train_type": "anima-lora"}, "set": "2e-5", "set_if_default": True}, {"watch": {"optimizer_type": "AdamW8bit", "model_train_type": "anima-lora"}, "set": "2e-5", "set_if_default": True}, {"watch": {"optimizer_type": "PagedAdamW8bit", "model_train_type": "anima-lora"}, "set": "2e-5", "set_if_default": True}, {"watch": {"optimizer_type": "Lion", "model_train_type": "anima-lora"}, "set": "5e-6", "set_if_default": True}, {"watch": {"optimizer_type": "Lion8bit", "model_train_type": "anima-lora"}, "set": "5e-6", "set_if_default": True}, {"watch": {"optimizer_type": "PagedLion8bit", "model_train_type": "anima-lora"}, "set": "5e-6", "set_if_default": True}, {"watch": "optimizer_type", "when": "Lion", "set": "2e-5", "set_if_default": True}, {"watch": "optimizer_type", "when": "Lion8bit", "set": "2e-5", "set_if_default": True}, {"watch": "optimizer_type", "when": "PagedLion8bit", "set": "2e-5", "set_if_default": True}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": "1e-4", "set_if_default": True}, {"watch": {"optimizer_type": CAME_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": "1.5e-5", "set_if_default": True}, {"watch": "optimizer_type", "when": CAME_OPTIMIZER_TYPE, "set": "1e-4", "set_if_default": True}, {"watch": {"optimizer_type": STABLE_ADAMW_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": "2e-5", "set_if_default": True}, {"watch": "optimizer_type", "when": STABLE_ADAMW_OPTIMIZER_TYPE, "set": "1e-4", "set_if_default": True}, {"watch": {"optimizer_type": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": "1e-4", "set_if_default": True}, {"watch": "optimizer_type", "when": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "set": "3e-4", "set_if_default": True}, {"watch": {"optimizer_type": ADAFACTOR_OPTIMIZER_TYPE, "model_train_type": "anima-lora", "adafactor_relative_step": False}, "set": "2e-5", "set_if_default": True}, {"watch": {"optimizer_type": EMOSENS_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": "0.1", "set_if_default": True}, {"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": "1.0", "set_if_default": True}], "readonly_if": {"key": "optimizer_type", "eq": PRODIGY_OPTIMIZER_TYPE, "_or": [PRODIGYPLUS_OPTIMIZER_TYPE], "reason_key": "field.learning_rate_prodigyLocked"}},
...
{"key": "came_fixed_decay", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.came_fixed_decay", "target": "merged", "hint_key": "field.came_fixed_decayHint", "show_if": {"key": "optimizer_type", "eq": "pytorch_optimizer.CAME"}},
