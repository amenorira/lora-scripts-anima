...
{"key": "network_dim", "type": "number", "default": 32, "section": "network", "desc_key": "field.network_dim", "hint_key": "field.network_dimHint", "hint_key_by": {"key": "optimizer_type", "values": {LORA_MUON_OPTIMIZER_TYPE: "field.network_dimHint_lora_muon"}}, "target": "toml", "min": 1, "max": 256, "step": 1, "doc_slug": "network-parameters", "doc_anchor": "dimension"},
{"key": "network_alpha", "type": "number", "default": 32, "section": "network", "desc_key": "field.network_alpha", "hint_key": "field.network_alphaHint", "hint_key_by": {"key": "optimizer_type", "values": {LORA_MUON_OPTIMIZER_TYPE: "field.network_alphaHint_lora_muon"}}, "target": "toml", "min": 1, "doc_slug": "network-parameters", "doc_anchor": "alpha"},
...
{"key": "network_dropout", "type": "number", "default": 0, "section": "network", "desc_key": "field.network_dropout", "target": "toml", "min": 0, "max": 0.5, "step": 0.01, "hint_key": "field.network_dropoutHint", "doc_slug": "network-parameters", "doc_anchor": "dropout"},
# ── 算法开关：network_module（选不同模块后，下列子参数紧随其后展开）──
{"key": "network_module", "type": "select", "default": "networks.lora", "section": "network", "desc_key": "field.network_module", "target": "toml", "doc_slug": "network-parameters", "doc_anchor": "algorithms", "options": [{"v": "networks.lora_anima", "l": "networks.lora_anima", "dk": "opt.network_module_networks_lora_anima", "group": "anima"}, {"v": "networks.lora", "l": "networks.lora", "dk": "opt.network_module_networks_lora", "group": "sdxl"}, {"v": "networks.loha", "l": "networks.loha", "dk": "opt.network_module_networks_loha"}, {"v": "networks.lokr", "l": "networks.lokr", "dk": "opt.network_module_networks_lokr"}, {"v": "lycoris.kohya", "l": "lycoris.kohya", "dk": "opt.network_module_lycoris_kohya"}]},
    ...
    {"key": "loraplus_lr_ratio", "type": "number", "default": 2.0, "section": "network", "desc_key": "field.loraplus_lr_ratio", "target": "ui", "min": 1.0, "step": 0.5, "layout_parent": "enable_loraplus", "show_if_any": _loraplus_ratio_show_if(), "hint_key": "field.loraplus_lr_ratioHint", "hint_key_by": {"key": "network_module", "values": {"networks.lora": "field.loraplus_lr_ratioHint_standard_lora", "networks.lora_anima": "field.loraplus_lr_ratioHint_standard_lora"}}, "doc_slug": "lora-plus", "doc_anchor": "loraplus-lr-ratio"},
    ...
    {"key": "lycoris_algo", "type": "select", "default": "lora", "section": "network", "desc_key": "field.lycoris_algo", "target": "ui", "show_if": {"key": "network_module", "eq": "lycoris.kohya"}, "doc_slug": "network-parameters", "doc_anchor": "algorithms", "options": [{"v": "lora", "l": "LoCon", "dk": "opt.lycoris_algo_locon"}, {"v": "loha", "l": "LoHa", "dk": "opt.lycoris_algo_loha"}, {"v": "lokr", "l": "LoKr", "dk": "opt.lycoris_algo_lokr"}]},
    ...
    {"key": "lokr_factor", "type": "number", "default": -1, "section": "network", "desc_key": "field.lokr_factor", "target": "ui", "min": -1, "step": 1, "show_if_any": [[{"key": "network_module", "eq": "networks.lokr"}], [{"key": "network_module", "eq": "lycoris.kohya"}, {"key": "lycoris_algo", "eq": "lokr"}]], "hint_key": "field.lokr_factorHint", "doc_slug": "network-parameters", "doc_anchor": "lokr-factor", "omit_default": True},
    ...
    {"key": "rank_dropout", "type": "number", "section": "network", "desc_key": "field.rank_dropout", "target": "ui", "min": 0, "max": 0.99, "step": 0.01, "show_if": {"key": "network_module", "eq": "networks.lora", "_or": ["networks.lora_anima", "networks.loha", "networks.lokr", "lycoris.kohya"]}, "hint_key": "field.rank_dropoutHint", "hint_key_by": {"key": "lycoris_algo", "values": {"lokr": "field.rank_dropoutHint_lokr"}}, "doc_slug": "network-parameters", "doc_anchor": "dropout"},
    {"key": "module_dropout", "type": "number", "section": "network", "desc_key": "field.module_dropout", "target": "ui", "min": 0, "max": 1, "step": 0.01, "show_if": {"key": "network_module", "eq": "networks.lora", "_or": ["networks.lora_anima", "networks.loha", "networks.lokr", "lycoris.kohya"]}, "hint_key": "field.module_dropoutHint", "doc_slug": "network-parameters", "doc_anchor": "dropout"},
    ...
    {"key": "decompose_both", "type": "toggle", "default": False, "section": "network", "desc_key": "field.decompose_both", "target": "ui", "show_if": [{"key": "network_module", "eq": "lycoris.kohya"}, {"key": "lycoris_algo", "eq": "lokr"}], "doc_slug": "network-parameters", "doc_anchor": "full-matrix", "omit_default": True},
    {"key": "dropout", "type": "number", "section": "network", "desc_key": "field.lycoris_dropout", "target": "ui", "min": 0, "max": 0.5, "step": 0.01, "show_if": {"key": "network_module", "eq": "lycoris.kohya"}, "hint_key": "field.lycoris_dropoutHint", "hint_key_by": {"key": "lycoris_algo", "values": {"lokr": "field.lycoris_dropoutHint_lokr"}}, "doc_slug": "network-parameters", "doc_anchor": "dropout"},
    # lycoris.kohya 算法子参数：算法特定的挂 lycoris_algo 下（show_if 末位是 lycoris_algo），
    # 对所有算法生效的 train_norm/bypass_mode 挂 network_module 下。
    {"key": "full_matrix", "type": "toggle", "default": False, "section": "network", "desc_key": "field.full_matrix", "target": "ui", "show_if": [{"key": "network_module", "eq": "lycoris.kohya"}, {"key": "lycoris_algo", "eq": "lokr"}], "doc_slug": "network-parameters", "doc_anchor": "full-matrix", "omit_default": True},
    ...
    {"key": "unbalanced_factorization", "type": "toggle", "default": False, "section": "network", "desc_key": "field.unbalanced_factorization", "target": "ui", "show_if": [{"key": "network_module", "eq": "lycoris.kohya"}, {"key": "lycoris_algo", "eq": "lokr"}], "doc_slug": "network-parameters", "doc_anchor": "unbalanced", "omit_default": True},
...
# ── Training Core ──
{"key": "max_train_epochs", "type": "number", "default": 10, "section": "training", "desc_key": "field.max_train_epochs", "hint_key": "field.max_train_epochsHint", "target": "toml", "min": 1},
...
{"key": "mixed_precision", "type": "select", "default": "bf16", "section": "training", "desc_key": "field.mixed_precision", "hint_key": "field.mixed_precisionHint", "target": "toml", "options": [{"v": "bf16", "l": "bf16", "dk": "opt.mixed_precision_bf16"}, {"v": "fp16", "l": "fp16", "dk": "opt.mixed_precision_fp16"}, {"v": "no", "l": "no", "dk": "opt.mixed_precision_no"}]},
    ...
    {"key": "sigmoid_scale", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.sigmoid_scale", "hint_key": "field.sigmoid_scaleHint", "target": "toml", "step": 0.05, "group": "anima", "show_if": {"key": "timestep_sampling", "eq": "sigmoid", "_or": ["shift", "flux_shift"]}, "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "sigmoid-scale"},
    {"key": "discrete_flow_shift", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.discrete_flow_shift", "hint_key": "field.discrete_flow_shiftHint", "target": "toml", "min": 0.01, "step": 0.05, "group": "anima", "show_if": {"key": "timestep_sampling", "eq": "shift", "_or": ["sigma"]}, "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "flow-shift"},
...
{"key": "weight_decay", "type": "number", "default": "", "section": "optimizer", "desc_key": "field.weight_decay", "target": "merged", "min": 0, "step": 0.01, "hint_key": "field.weight_decayHint", "doc_slug": "optimizers", "doc_anchor": "weight-decay", "auto_value": SD_OPTIMIZER_AUTO_VALUES["weight_decay"], "layout_parent": "optimizer_type"},
...
{"key": "automagic_fused", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.automagic_fused", "target": "merged", "show_if": {"key": "optimizer_type", "eq": AUTOMAGIC_OPTIMIZER_TYPE}, "auto_value": [{"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": False}], "readonly_if_any": [{"key": "gradient_accumulation_steps", "neq": 1}, {"key": "max_grad_norm", "neq": 0}, {"key": "mixed_precision", "eq": "fp16"}], "readonly_reason_key": "field.automagic_fusedLocked"},
    ...
    {"key": "stopcoef", "type": "number", "default": 0.04, "section": "optimizer", "desc_key": "field.stopcoef", "target": "merged", "min": 0, "step": 0.001, "hint_key": "field.stopcoefHint", "show_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE}},
    {"key": "notify", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.notify", "target": "merged", "hint_key": "field.notifyHint", "show_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE}},
    {"key": "use_shadow", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.use_shadow", "target": "merged", "hint_key": "field.use_shadowHint", "show_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE}},
...
{"key": "d_limiter", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.d_limiter", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.d_limiterHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "schedulefree_c", "type": "number", "default": 0, "section": "optimizer", "desc_key": "field.schedulefree_c", "target": "merged", "min": 0, "step": 1, "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.schedulefree_cHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "prodigy_steps", "type": "number", "default": 0, "section": "optimizer", "desc_key": "field.prodigy_steps", "target": "merged", "min": 0, "step": 1, "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.prodigy_stepsHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "use_bias_correction", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.use_bias_correction", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.use_bias_correctionHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "use_speed", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.use_speed", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.use_speedHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "use_cautious", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.use_cautious", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.use_cautiousHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "use_orthograd", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.use_orthograd", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.use_orthogradHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "factored", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.factored", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.factoredHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "factored_fp32", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.factored_fp32", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.factored_fp32Hint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "split_groups", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.split_groups", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.split_groupsHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "split_groups_mean", "type": "toggle", "default": False, "section": "optimizer", "desc_key": "field.split_groups_mean", "target": "merged", "show_if": [{"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, {"key": "split_groups", "eq": True}], "hint_key": "field.split_groups_meanHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
{"key": "weight_decay_by_lr", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.weight_decay_by_lr", "target": "merged", "show_if": {"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, "hint_key": "field.weight_decay_by_lrHint", "doc_slug": "optimizers", "doc_anchor": "prodigyplus-options"},
...
{"key": "eps", "type": "text", "section": "optimizer", "desc_key": "field.eps", "target": "merged", "hint_key": "field.epsHint", "hint_key_by": {"key": "optimizer_type", "values": {LORARITE_OPTIMIZER_TYPE: "field.epsHint_lorarite", PRODIGYPLUS_OPTIMIZER_TYPE: "field.epsHint_prodigyplus"}}, "doc_slug": "optimizers", "doc_anchor": "eps", "show_if": _show_if_one_of("optimizer_type", tuple(selector for selector in _SD_OPTIMIZER_SELECTORS if selector in _SD_EPS_OPTIMIZERS)), "auto_value": SD_OPTIMIZER_AUTO_VALUES["eps"]},
# ── CAME 专用参数 ──
...
# 不读 noise_offset/adaptive_noise_scale/multires_noise_*；min_snr/debiased 仅 sdxl_train.py/fine_tune.py 消费）。
    {"key": "min_snr_gamma", "type": "number", "section": "regularization", "desc_key": "field.min_snr_gamma", "target": "toml", "step": 1, "hint_key": "field.min_snr_gammaHint", "group": "sdxl"},
...
{"key": "negative_prompts", "type": "textarea", "default": "", "section": "preview", "desc_key": "field.negative_prompts", "target": "ui", "show_if": {"key": "enable_preview", "eq": True}},
    ...
    {"key": "sample_cfg", "type": "number", "default": 7, "section": "preview", "desc_key": "field.sample_cfg", "target": "ui", "min": 1, "max": 30, "step": 0.5, "hint_key": "field.sample_cfgHint", "show_if": {"key": "enable_preview", "eq": True}},
# 预览分辨率默认 1024（SDXL/Anima 训练基准），原 512 在高分辨率模型下采样不具代表性
    ...
    {"key": "sample_flow_shift", "type": "number", "default": 3.0, "section": "preview", "desc_key": "field.sample_flow_shift", "hint_key": "field.sample_flow_shiftHint", "target": "ui", "group": "anima", "step": 0.05, "show_if": {"key": "enable_preview", "eq": True}},
]
