...
{"key": "network_dim", "type": "number", "default": 32, "section": "network", "desc_key": "field.network_dim", "hint_key": "field.network_dimHint", "hint_key_by": {"key": "optimizer_type", "values": {LORA_MUON_OPTIMIZER_TYPE: "field.network_dimHint_lora_muon"}}, "target": "toml", "min": 1, "max": 256, "step": 1, "auto_value": [{"watch": {"optimizer_type": LORA_MUON_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": 16, "set_if_default": True}]},
{"key": "network_alpha", "type": "number", "default": 32, "section": "network", "desc_key": "field.network_alpha", "hint_key": "field.network_alphaHint", "hint_key_by": {"key": "optimizer_type", "values": {LORA_MUON_OPTIMIZER_TYPE: "field.network_alphaHint_lora_muon"}}, "target": "toml", "min": 1, "auto_value": [{"watch": {"optimizer_type": LORA_MUON_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": 16, "set_if_default": True}]},
...
{"key": "inv_sqrt_steps", "type": "number", "default": 7, "section": "optimizer", "desc_key": "field.lora_muon_inv_sqrt_steps", "hint_key": "field.lora_muon_inv_sqrt_stepsHint", "target": "merged", "min": 1, "max": 7, "step": 1, "show_if": {"key": "optimizer_type", "eq": LORA_MUON_OPTIMIZER_TYPE}, "auto_value": [{"watch": {"optimizer_type": LORA_MUON_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": 5, "set_if_default": True}], "doc_slug": "optimizers", "doc_anchor": "lora-muon-options"},
