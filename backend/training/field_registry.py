...
{"key": "gradient_accumulation_steps", "type": "number", "default": 1, "section": "training", "desc_key": "field.gradient_accumulation_steps", "target": "toml", "min": 1, "auto_value": [{"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": 1}], "readonly_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE, "reason_key": "field.gradient_accumulation_steps_emosensLocked"}, "omit_default": True},
...
{"key": "mixed_precision", "type": "select", "default": "bf16", "section": "training", "desc_key": "field.mixed_precision", "target": "toml", "options": [{"v": "bf16", "l": "bf16", "dk": "opt.mixed_precision_bf16"}, {"v": "fp16", "l": "fp16", "dk": "opt.mixed_precision_fp16"}, {"v": "no", "l": "no", "dk": "opt.mixed_precision_no"}]},
    ...
    {"key": "sigmoid_scale", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.sigmoid_scale", "target": "toml", "step": 0.001, "group": "anima", "show_if": {"key": "timestep_sampling", "eq": "sigmoid", "_or": ["shift", "flux_shift"]}, "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "sigmoid-scale"},
    {"key": "discrete_flow_shift", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.discrete_flow_shift", "target": "toml", "min": 0.01, "step": 0.01, "group": "anima", "show_if": {"key": "timestep_sampling", "eq": "shift", "_or": ["sigma"]}, "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "flow-shift"},
    ...
    {"key": "logit_mean", "type": "number", "default": 0.0, "section": "training", "desc_key": "field.logit_mean", "target": "toml", "step": 0.01, "group": "anima", "show_if": [{"key": "weighting_scheme", "eq": "logit_normal"}, {"key": "timestep_sampling", "eq": "sigma"}], "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "logit-normal"},
    {"key": "logit_std", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.logit_std", "target": "toml", "step": 0.01, "group": "anima", "show_if": [{"key": "weighting_scheme", "eq": "logit_normal"}, {"key": "timestep_sampling", "eq": "sigma"}], "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "logit-normal"},
    {"key": "mode_scale", "type": "number", "default": 1.29, "section": "training", "desc_key": "field.mode_scale", "target": "toml", "step": 0.01, "group": "anima", "show_if": [{"key": "weighting_scheme", "eq": "mode"}, {"key": "timestep_sampling", "eq": "sigma"}], "omit_default": True, "doc_slug": "timesteps", "doc_anchor": "mode"},
    # SDXL/SD3: 时间步范围控制（advanced；对 Anima flow-matching 训练无效，故划归 sdxl 组）
    {"key": "min_timestep", "type": "number", "section": "training", "desc_key": "field.min_timestep", "target": "toml", "min": 0, "max": 999, "step": 1, "group": "sdxl", "advanced": True, "hint_key": "field.min_timestepHint", "doc_slug": "timesteps", "doc_anchor": "sdxl-range"},
    {"key": "max_timestep", "type": "number", "default": "", "section": "training", "desc_key": "field.max_timestep", "target": "toml", "min": 1, "max": 1000, "step": 1, "group": "sdxl", "advanced": True, "hint_key": "field.max_timestepHint", "doc_slug": "timesteps", "doc_anchor": "sdxl-range"},
# ── Optimizer & Learning Rate ──
{"key": "optimizer_type", "type": "select", "default": "AdamW8bit", "section": "optimizer", "desc_key": "field.optimizer_type", "target": "toml", "doc_slug": "optimizers", "doc_anchor": "optimizer-type", "groups": [{"label_key": "opt.optimizer_group_adamw", "options": [{"v": "AdamW", "l": "AdamW", "dk": "opt.optimizer_type_AdamW"}, {"v": "AdamW8bit", "l": "AdamW8bit", "dk": "opt.optimizer_type_AdamW8bit"}, {"v": "PagedAdamW8bit", "l": "PagedAdamW8bit", "dk": "opt.optimizer_type_PagedAdamW8bit"}, {"v": STABLE_ADAMW_OPTIMIZER_TYPE, "l": "StableAdamW", "dk": "opt.optimizer_type_StableAdamW"}]}, {"label_key": "opt.optimizer_group_lion", "options": [{"v": "Lion", "l": "Lion", "dk": "opt.optimizer_type_Lion"}, {"v": "Lion8bit", "l": "Lion8bit", "dk": "opt.optimizer_type_Lion8bit"}, {"v": "PagedLion8bit", "l": "PagedLion8bit", "dk": "opt.optimizer_type_PagedLion8bit"}]}, {"label_key": "opt.optimizer_group_prodigy", "options": [{"v": PRODIGY_OPTIMIZER_TYPE, "l": "Prodigy", "dk": "opt.optimizer_type_Prodigy"}, {"v": PRODIGYPLUS_OPTIMIZER_TYPE, "l": "ProdigyPlusScheduleFree", "dk": "opt.optimizer_type_ProdigyPlus"}]}, {"label_key": "opt.optimizer_group_automagic", "options": [{"v": AUTOMAGIC_OPTIMIZER_TYPE, "l": "Automagic3", "dk": "opt.optimizer_type_Automagic3"}]}, {"label_key": "opt.optimizer_group_other", "options": [{"v": ADAFACTOR_OPTIMIZER_TYPE, "l": "AdaFactor", "dk": "opt.optimizer_type_AdaFactor"}, {"v": CAME_OPTIMIZER_TYPE, "l": "CAME", "dk": "opt.optimizer_type_CAME"}, {"v": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "l": "AdamWScheduleFree", "dk": "opt.optimizer_type_AdamWScheduleFree"}]}, {"label_key": "opt.optimizer_group_emo", "options": [{"v": EMOSENS_OPTIMIZER_TYPE, "l": "EmoSens", "dk": "opt.optimizer_type_EmoSens"}]}]},
...
{"key": "learning_rate", "type": "text", "default": "1e-4", "section": "optimizer", "desc_key": "field.learning_rate", "target": "toml", "doc_slug": "optimizers", "doc_anchor": "learning-rate", "auto_value": [{"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": "1.0"}, {"watch": "optimizer_type", "when": PRODIGYPLUS_OPTIMIZER_TYPE, "set": "1.0"}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": "1e-4", "set_if_default": True}, {"watch": "optimizer_type", "when": CAME_OPTIMIZER_TYPE, "set": "2e-4", "set_if_default": True}, {"watch": "optimizer_type", "when": STABLE_ADAMW_OPTIMIZER_TYPE, "set": "1e-4", "set_if_default": True}, {"watch": "optimizer_type", "when": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "set": "3e-4", "set_if_default": True}, {"watch": {"optimizer_type": EMOSENS_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": "0.1", "set_if_default": True}, {"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": "1.0", "set_if_default": True}], "readonly_if": {"key": "optimizer_type", "eq": PRODIGY_OPTIMIZER_TYPE, "_or": [PRODIGYPLUS_OPTIMIZER_TYPE], "reason_key": "field.learning_rate_prodigyLocked"}},
...
{"key": "max_grad_norm", "type": "number", "default": 1.0, "section": "optimizer", "desc_key": "field.max_grad_norm", "target": "toml", "min": 0, "step": 0.1, "auto_value": [{"watch": "optimizer_type", "when": ADAFACTOR_OPTIMIZER_TYPE, "set": 0}, {"watch": {"optimizer_type": PRODIGYPLUS_OPTIMIZER_TYPE, "prodigyplus_use_stableadamw": True}, "set": 0}, {"watch": {"optimizer_type": PRODIGYPLUS_OPTIMIZER_TYPE, "eps": "None"}, "set": 0}, {"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": 0, "set_if_default": True}], "readonly_if_any": [{"key": "optimizer_type", "eq": ADAFACTOR_OPTIMIZER_TYPE}, [{"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, {"key": "prodigyplus_use_stableadamw", "eq": True}], [{"key": "optimizer_type", "eq": PRODIGYPLUS_OPTIMIZER_TYPE}, {"key": "eps", "eq": "None"}]], "readonly_reason_key": "field.max_grad_norm_optimizerLocked", "omit_default": True, "doc_slug": "optimizers", "doc_anchor": "gradient-clipping"},
{"key": "weight_decay", "type": "number", "default": "", "section": "optimizer", "desc_key": "field.weight_decay", "target": "merged", "min": 0, "step": 0.001, "hint_key": "field.weight_decayHint", "doc_slug": "optimizers", "doc_anchor": "weight-decay", "auto_value": [{"watch": "optimizer_type", "when": "AdamW", "set": 0.01, "set_if_default": True}, {"watch": "optimizer_type", "when": "AdamW8bit", "set": 0.01, "set_if_default": True}, {"watch": "optimizer_type", "when": "PagedAdamW8bit", "set": 0.01, "set_if_default": True}, {"watch": "optimizer_type", "when": "Lion", "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": "Lion8bit", "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": "PagedLion8bit", "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": PRODIGYPLUS_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": ADAFACTOR_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": CAME_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": STABLE_ADAMW_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": 0.0, "set_if_default": True}, {"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": 0.01, "set_if_default": True}]},
{"key": "bnb_percentile_clipping", "type": "number", "default": 100, "section": "optimizer", "desc_key": "field.bnb_percentile_clipping", "target": "merged", "min": 1, "max": 100, "step": 1, "show_if": {"key": "optimizer_type", "eq": "AdamW8bit", "_or": ["PagedAdamW8bit", "Lion8bit", "PagedLion8bit"]}, "hint_key": "field.bnb_percentile_clippingHint", "advanced": True, "doc_slug": "optimizers", "doc_anchor": "percentile-clipping"},
{"key": "bnb_min_8bit_size", "type": "number", "default": 4096, "section": "optimizer", "desc_key": "field.bnb_min_8bit_size", "target": "merged", "min": 0, "step": 1, "show_if": {"key": "optimizer_type", "eq": "AdamW8bit", "_or": ["PagedAdamW8bit", "Lion8bit", "PagedLion8bit"]}, "hint_key": "field.bnb_min_8bit_sizeHint", "advanced": True, "doc_slug": "optimizers", "doc_anchor": "min-8bit-size"},
...
{"key": "betas", "type": "text", "section": "optimizer", "desc_key": "field.betas", "target": "merged", "hint_key": "field.betasHint", "doc_slug": "optimizers", "doc_anchor": "betas", "show_if": {"key": "optimizer_type", "eq": "AdamW", "_or": ["AdamW8bit", "PagedAdamW8bit", "Lion", "Lion8bit", "PagedLion8bit", CAME_OPTIMIZER_TYPE, STABLE_ADAMW_OPTIMIZER_TYPE, EMOSENS_OPTIMIZER_TYPE, ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, PRODIGY_OPTIMIZER_TYPE, PRODIGYPLUS_OPTIMIZER_TYPE]}, "auto_value": [{"watch": "optimizer_type", "when": "AdamW", "set": "0.9, 0.999", "set_if_default": True}, {"watch": "optimizer_type", "when": "AdamW8bit", "set": "0.9, 0.999", "set_if_default": True}, {"watch": "optimizer_type", "when": "PagedAdamW8bit", "set": "0.9, 0.999", "set_if_default": True}, {"watch": "optimizer_type", "when": "Lion", "set": "0.9, 0.99", "set_if_default": True}, {"watch": "optimizer_type", "when": "Lion8bit", "set": "0.9, 0.99", "set_if_default": True}, {"watch": "optimizer_type", "when": "PagedLion8bit", "set": "0.9, 0.99", "set_if_default": True}, {"watch": "optimizer_type", "when": CAME_OPTIMIZER_TYPE, "set": "0.9, 0.999, 0.9999", "set_if_default": True}, {"watch": "optimizer_type", "when": STABLE_ADAMW_OPTIMIZER_TYPE, "set": "0.9, 0.99", "set_if_default": True}, {"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": "0.9, 0.995", "set_if_default": True}, {"watch": "optimizer_type", "when": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "set": "0.9, 0.999", "set_if_default": True}, {"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": "0.9, 0.999", "set_if_default": True}, {"watch": "optimizer_type", "when": PRODIGYPLUS_OPTIMIZER_TYPE, "set": "0.9, 0.99", "set_if_default": True}]},
{"key": "eps", "type": "text", "section": "optimizer", "desc_key": "field.eps", "target": "merged", "hint_key": "field.epsHint", "doc_slug": "optimizers", "doc_anchor": "eps", "show_if": {"key": "optimizer_type", "eq": "AdamW", "_or": ["AdamW8bit", "PagedAdamW8bit", STABLE_ADAMW_OPTIMIZER_TYPE, EMOSENS_OPTIMIZER_TYPE, ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, PRODIGY_OPTIMIZER_TYPE, PRODIGYPLUS_OPTIMIZER_TYPE, AUTOMAGIC_OPTIMIZER_TYPE]}, "auto_value": [{"watch": "optimizer_type", "when": "AdamW", "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": "AdamW8bit", "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": "PagedAdamW8bit", "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": STABLE_ADAMW_OPTIMIZER_TYPE, "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": PRODIGYPLUS_OPTIMIZER_TYPE, "set": "1e-8", "set_if_default": True}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": "1e-30", "set_if_default": True}]},
# ── CAME 专用参数 ──
...
{"key": "came_clip_threshold", "type": "number", "default": 1.0, "section": "optimizer", "desc_key": "field.came_clip_threshold", "target": "merged", "step": 0.1, "min": 0.1, "show_if": {"key": "optimizer_type", "eq": "pytorch_optimizer.CAME"}, "doc_slug": "optimizers", "doc_anchor": "came-clipping"},
