...
{"key": "network_args_custom", "type": "textarea", "default": "", "section": "network", "desc_key": "field.network_args_custom", "target": "ui", "hint_key": "field.network_args_customHint"},
    # LyCORIS (show_if network_module=networks.loha or networks.lokr)
...
{"key": "optimizer_type", "type": "select", "default": "AdamW8bit", "section": "training", "desc_key": "field.optimizer_type", "target": "toml", "groups": [{"label_key": "opt.optimizer_group_adamw", "options": [{"v": "AdamW", "l": "AdamW", "dk": "opt.optimizer_type_AdamW"}, {"v": "AdamW8bit", "l": "AdamW8bit", "dk": "opt.optimizer_type_AdamW8bit"}, {"v": "PagedAdamW8bit", "l": "PagedAdamW8bit", "dk": "opt.optimizer_type_PagedAdamW8bit"}]}, {"label_key": "opt.optimizer_group_lion", "options": [{"v": "Lion", "l": "Lion", "dk": "opt.optimizer_type_Lion"}, {"v": "Lion8bit", "l": "Lion8bit", "dk": "opt.optimizer_type_Lion8bit"}, {"v": "PagedLion8bit", "l": "PagedLion8bit", "dk": "opt.optimizer_type_PagedLion8bit"}]}, {"label_key": "opt.optimizer_group_prodigy", "options": [{"v": "Prodigy", "l": "Prodigy", "dk": "opt.optimizer_type_Prodigy"}, {"v": "prodigyplus.ProdigyPlusScheduleFree", "l": "ProdigyPlusScheduleFree", "dk": "opt.optimizer_type_ProdigyPlus"}]}, {"label_key": "opt.optimizer_group_other", "options": [{"v": "AdaFactor", "l": "AdaFactor", "dk": "opt.optimizer_type_AdaFactor"}, {"v": "pytorch_optimizer.CAME", "l": "CAME", "dk": "opt.optimizer_type_CAME"}, {"v": "AdamWScheduleFree", "l": "AdamWScheduleFree", "dk": "opt.optimizer_type_AdamWScheduleFree"}]}]},
{"key": "learning_rate", "type": "text", "default": "1e-4", "section": "training", "desc_key": "field.learning_rate", "target": "toml", "auto_value": [{"watch": "optimizer_type", "when": "Prodigy", "set": "1.0"}, {"watch": "optimizer_type", "when": "prodigyplus.ProdigyPlusScheduleFree", "set": "1.0"}]},
{"key": "unet_lr", "type": "text", "default": "1e-4", "section": "training", "desc_key": "field.unet_lr", "target": "toml"},
{"key": "text_encoder_lr", "type": "text", "default": "1e-5", "section": "training", "desc_key": "field.text_encoder_lr", "target": "toml"},
{"key": "lr_scheduler", "type": "select", "default": "cosine_with_restarts", "section": "training", "desc_key": "field.lr_scheduler", "target": "toml", "options": [{"v": "cosine_with_restarts", "l": "cosine_with_restarts", "dk": "opt.lr_scheduler_cosine_with_restarts"}, {"v": "cosine", "l": "cosine", "dk": "opt.lr_scheduler_cosine"}, {"v": "linear", "l": "linear", "dk": "opt.lr_scheduler_linear"}, {"v": "constant", "l": "constant", "dk": "opt.lr_scheduler_constant"}, {"v": "constant_with_warmup", "l": "constant_with_warmup", "dk": "opt.lr_scheduler_constant_with_warmup"}]},
...
{"key": "max_grad_norm", "type": "number", "default": 1.0, "section": "training", "desc_key": "field.max_grad_norm", "target": "toml", "step": 0.1},
{"key": "weight_decay", "type": "number", "section": "training", "desc_key": "field.weight_decay", "target": "merged", "step": 0.001, "hint_key": "field.weight_decayHint"},
...
{"key": "optimizer_args_custom", "type": "textarea", "default": "", "section": "training", "desc_key": "field.optimizer_args_custom", "target": "ui", "hint_key": "field.optimizer_args_customHint"},
...
{"key": "min_snr_gamma", "type": "number", "section": "training", "desc_key": "field.min_snr_gamma", "target": "toml", "step": 0.1},
{"key": "noise_offset", "type": "number", "section": "training", "desc_key": "field.noise_offset", "target": "toml", "step": 0.001},
{"key": "zero_terminal_snr", "type": "toggle", "default": False, "section": "training", "desc_key": "field.zero_terminal_snr", "target": "toml"},
