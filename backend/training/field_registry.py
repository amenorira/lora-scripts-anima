...
AUTOMAGIC_SCHEDULER_TYPE = "vendor.automagic_optimizer.scheduler.AutomagicPassthrough"
EMOSENS_OPTIMIZER_TYPE = "vendor.emo_optimizer.emosens.EmoSens"
EMOPULSE_SCHEDULER_TYPE = "vendor.emo_optimizer.emopulse_scheduler.EmoPulse"
...
{"key": "lr_scheduler", "type": "select", "default": "cosine_with_restarts", "section": "optimizer", "desc_key": "field.lr_scheduler", "target": "toml", "options": [{"v": "cosine_with_restarts", "l": "cosine_with_restarts", "dk": "opt.lr_scheduler_cosine_with_restarts"}, {"v": "cosine", "l": "cosine", "dk": "opt.lr_scheduler_cosine"}, {"v": "linear", "l": "linear", "dk": "opt.lr_scheduler_linear"}, {"v": "polynomial", "l": "polynomial", "dk": "opt.lr_scheduler_polynomial"}, {"v": "constant", "l": "constant", "dk": "opt.lr_scheduler_constant"}, {"v": "constant_with_warmup", "l": "constant_with_warmup", "dk": "opt.lr_scheduler_constant_with_warmup"}], "auto_value": [{"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": "constant"}, {"watch": "optimizer_type", "when": "AdamWScheduleFree", "set": "constant"}, {"watch": "optimizer_type", "when": "prodigyplus.ProdigyPlusScheduleFree", "set": "constant"}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": "constant"}], "readonly_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE, "_or": ["AdamWScheduleFree", "prodigyplus.ProdigyPlusScheduleFree", AUTOMAGIC_OPTIMIZER_TYPE], "reason_key": "field.lr_scheduler_locked"}},
    ...
    {"key": "lr_scheduler_type", "type": "select", "default": "", "section": "optimizer", "desc_key": "field.lr_scheduler_type", "target": "toml", "options": [{"v": "", "l": "None (use lr_scheduler)", "dk": "opt.lr_scheduler_type_none"}, {"v": EMOPULSE_SCHEDULER_TYPE, "l": "EmoPulse", "dk": "opt.lr_scheduler_type_emopulse"}, {"v": AUTOMAGIC_SCHEDULER_TYPE, "l": "Automagic internal LR", "dk": "opt.lr_scheduler_type_automagic"}], "auto_value": [{"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": EMOPULSE_SCHEDULER_TYPE}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": AUTOMAGIC_SCHEDULER_TYPE}], "readonly_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE, "_or": ["AdamWScheduleFree", "prodigyplus.ProdigyPlusScheduleFree", AUTOMAGIC_OPTIMIZER_TYPE], "reason_key": "field.lr_scheduler_type_locked"}, "omit_default": True},
{"key": "lr_warmup_steps", "type": "number", "default": 0, "section": "optimizer", "desc_key": "field.lr_warmup_steps", "target": "toml", "min": 0, "auto_value": [{"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": 0}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": 0}, {"watch": "lr_scheduler_type", "neq": "", "set": 0}], "readonly_if": {"key": "optimizer_type", "eq": EMOSENS_OPTIMIZER_TYPE, "_or": [AUTOMAGIC_OPTIMIZER_TYPE], "reason_key": "field.lr_warmup_steps_internalLocked"}, "omit_default": True},
...
{"key": "max_grad_norm", "type": "number", "default": 1.0, "section": "optimizer", "desc_key": "field.max_grad_norm", "target": "toml", "step": 0.1, "omit_default": True},
{"key": "weight_decay", "type": "number", "default": "", "section": "optimizer", "desc_key": "field.weight_decay", "target": "merged", "step": 0.001, "hint_key": "field.weight_decayHint", "auto_value": [{"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": 0.01}]},
...
{"key": "betas", "type": "text", "section": "optimizer", "desc_key": "field.betas", "target": "merged", "hint_key": "field.betasHint", "show_if": {"key": "optimizer_type", "eq": "AdamW", "_or": ["AdamW8bit", "PagedAdamW8bit", "Lion", "Lion8bit", "PagedLion8bit", "pytorch_optimizer.CAME", EMOSENS_OPTIMIZER_TYPE, "AdamWScheduleFree", "Prodigy", "prodigyplus.ProdigyPlusScheduleFree"]}},
{"key": "eps", "type": "text", "section": "optimizer", "desc_key": "field.eps", "target": "merged", "hint_key": "field.epsHint", "show_if": {"key": "optimizer_type", "eq": "AdamW", "_or": ["AdamW8bit", "PagedAdamW8bit", EMOSENS_OPTIMIZER_TYPE, "AdamWScheduleFree", "Prodigy", "prodigyplus.ProdigyPlusScheduleFree", AUTOMAGIC_OPTIMIZER_TYPE]}},
# ── CAME 专用参数 ──
