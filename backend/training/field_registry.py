...
{"key": "network_args_custom", "type": "textarea", "default": "", "section": "network", "desc_key": "field.network_args_custom", "target": "ui", "hint_key": "field.network_args_customHint"},
    # lycoris.kohya 算法选择器
    {"key": "lycoris_algo", "type": "select", "default": "lora", "section": "network", "desc_key": "field.lycoris_algo", "target": "ui", "show_if": {"key": "network_module", "eq": "lycoris.kohya"}, "options": [{"v": "lora", "l": "LoCon (增强版 LoRA+Conv)", "dk": "opt.lycoris_algo_locon"}, {"v": "loha", "l": "LoHa (Hadamard)", "dk": "opt.lycoris_algo_loha"}, {"v": "lokr", "l": "LoKr (Kronecker)", "dk": "opt.lycoris_algo_lokr"}, {"v": "dylora", "l": "DyLoRA (动态秩)", "dk": "opt.lycoris_algo_dylora"}, {"v": "glora", "l": "GLoRA (广义 LoRA)", "dk": "opt.lycoris_algo_glora"}, {"v": "diag-oft", "l": "Diag-OFT (对角正交微调)", "dk": "opt.lycoris_algo_diagoft"}, {"v": "boft", "l": "Butterfly OFT (蝶形正交微调)", "dk": "opt.lycoris_algo_boft"}, {"v": "ia3", "l": "IA³ (注入式适配器)", "dk": "opt.lycoris_algo_ia3"}]},
    ...
    {"key": "use_cp", "type": "toggle", "default": False, "section": "network", "desc_key": "field.use_cp", "target": "ui", "show_if": {"key": "network_module", "eq": "networks.loha", "_or": ["networks.lokr", "lycoris.kohya"]}},
    {"key": "use_scalar", "type": "toggle", "default": False, "section": "network", "desc_key": "field.use_scalar", "target": "ui", "show_if": {"key": "network_module", "eq": "networks.loha", "_or": ["networks.lokr", "lycoris.kohya"]}},
    {"key": "decompose_both", "type": "toggle", "default": False, "section": "network", "desc_key": "field.decompose_both", "target": "ui", "show_if": {"key": "network_module", "eq": "networks.loha", "_or": ["networks.lokr", "lycoris.kohya"]}},
    {"key": "full_matrix", "type": "toggle", "default": False, "section": "network", "desc_key": "field.full_matrix", "target": "ui", "show_if": {"key": "network_module", "eq": "networks.loha", "_or": ["networks.lokr", "lycoris.kohya"]}},
    {"key": "train_norm", "type": "toggle", "default": False, "section": "network", "desc_key": "field.train_norm", "target": "ui", "show_if": {"key": "network_module", "eq": "networks.loha", "_or": ["networks.lokr", "lycoris.kohya"]}},
    ...
    {"key": "dropout", "type": "number", "section": "network", "desc_key": "field.lycoris_dropout", "target": "ui", "min": 0, "max": 0.5, "step": 0.01, "show_if": {"key": "network_module", "eq": "networks.loha", "_or": ["networks.lokr", "lycoris.kohya"]}, "hint_key": "field.lycoris_dropoutHint"},
    # lycoris.kohya 专有参数
