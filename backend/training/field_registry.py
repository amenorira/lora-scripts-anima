...
{"key": "optimizer_type", "type": "select", "default": "AdamW8bit", "section": "optimizer", "desc_key": "field.optimizer_type", "target": "toml", "groups": [{"label_key": "opt.optimizer_group_adamw", "options": [{"v": "AdamW", "l": "AdamW", "dk": "opt.optimizer_type_AdamW"}, {"v": "AdamW8bit", "l": "AdamW8bit", "dk": "opt.optimizer_type_AdamW8bit"}, {"v": "PagedAdamW8bit", "l": "PagedAdamW8bit", "dk": "opt.optimizer_type_PagedAdamW8bit"}]}, {"label_key": "opt.optimizer_group_lion", "options": [{"v": "Lion", "l": "Lion", "dk": "opt.optimizer_type_Lion"}, {"v": "Lion8bit", "l": "Lion8bit", "dk": "opt.optimizer_type_Lion8bit"}, {"v": "PagedLion8bit", "l": "PagedLion8bit", "dk": "opt.optimizer_type_PagedLion8bit"}]}, {"label_key": "opt.optimizer_group_prodigy", "options": [{"v": PRODIGY_OPTIMIZER_TYPE, "l": "Prodigy", "dk": "opt.optimizer_type_Prodigy"}, {"v": PRODIGYPLUS_OPTIMIZER_TYPE, "l": "ProdigyPlusScheduleFree", "dk": "opt.optimizer_type_ProdigyPlus"}]}, {"label_key": "opt.optimizer_group_automagic", "options": [{"v": AUTOMAGIC_OPTIMIZER_TYPE, "l": "Automagic3", "dk": "opt.optimizer_type_Automagic3"}]}, {"label_key": "opt.optimizer_group_other", "options": [{"v": ADAFACTOR_OPTIMIZER_TYPE, "l": "AdaFactor", "dk": "opt.optimizer_type_AdaFactor"}, {"v": CAME_OPTIMIZER_TYPE, "l": "CAME", "dk": "opt.optimizer_type_CAME"}, {"v": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "l": "AdamWScheduleFree", "dk": "opt.optimizer_type_AdamWScheduleFree"}]}, {"label_key": "opt.optimizer_group_emo", "options": [{"v": EMOSENS_OPTIMIZER_TYPE, "l": "EmoSens", "dk": "opt.optimizer_type_EmoSens"}]}]},
...
{"key": "learning_rate", "type": "text", "default": "1e-4", "section": "optimizer", "desc_key": "field.learning_rate", "target": "toml", "auto_value": [{"watch": "optimizer_type", "when": PRODIGY_OPTIMIZER_TYPE, "set": "1.0"}, {"watch": "optimizer_type", "when": PRODIGYPLUS_OPTIMIZER_TYPE, "set": "1.0"}, {"watch": "optimizer_type", "when": AUTOMAGIC_OPTIMIZER_TYPE, "set": "1e-4", "set_if_default": True}, {"watch": "optimizer_type", "when": CAME_OPTIMIZER_TYPE, "set": "2e-4", "set_if_default": True}, {"watch": "optimizer_type", "when": ADAMW_SCHEDULEFREE_OPTIMIZER_TYPE, "set": "0.0025", "set_if_default": True}, {"watch": {"optimizer_type": EMOSENS_OPTIMIZER_TYPE, "model_train_type": "anima-lora"}, "set": "0.1", "set_if_default": True}, {"watch": "optimizer_type", "when": EMOSENS_OPTIMIZER_TYPE, "set": "1.0", "set_if_default": True}], "readonly_if": {"key": "optimizer_type", "eq": PRODIGY_OPTIMIZER_TYPE, "_or": [PRODIGYPLUS_OPTIMIZER_TYPE], "reason_key": "field.learning_rate_prodigyLocked"}},
