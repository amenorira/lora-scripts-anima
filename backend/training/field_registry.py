...
{"key": "optimizer_type", "type": "select", "default": "AdamW8bit", "section": "optimizer", "desc_key": "field.optimizer_type", "target": "toml", "doc_slug": "optimizers", "doc_anchor": "optimizer-type", "groups": optimizer_groups(SD_SCRIPTS_PROFILE)},
...
{"key": "learning_rate", "type": "text", "default": "1e-4", "section": "optimizer", "desc_key": "field.learning_rate", "target": "toml", "doc_slug": "optimizers", "doc_anchor": "learning-rate", "auto_value": SD_OPTIMIZER_AUTO_VALUES["learning_rate"], "readonly_if": {"key": "optimizer_type", "eq": PRODIGY_OPTIMIZER_TYPE, "_or": [PRODIGYPLUS_OPTIMIZER_TYPE], "reason_key": "field.learning_rate_prodigyLocked"}},
...
{"key": "weight_decay", "type": "number", "default": "", "section": "optimizer", "desc_key": "field.weight_decay", "target": "merged", "min": 0, "step": 0.001, "hint_key": "field.weight_decayHint", "doc_slug": "optimizers", "doc_anchor": "weight-decay", "auto_value": SD_OPTIMIZER_AUTO_VALUES["weight_decay"]},
...
{"key": "muon_momentum", "type": "number", "default": 0.95, "section": "optimizer", "desc_key": "field.muon_momentum", "hint_key": "field.muon_momentumHint", "target": "merged", "min": 0, "step": 0.01, "show_if": {"key": "optimizer_type", "eq": MUON_OPTIMIZER_TYPE}, "advanced": True, "doc_slug": "optimizers", "doc_anchor": "muon-options"},
{"key": "muon_nesterov", "type": "toggle", "default": True, "section": "optimizer", "desc_key": "field.muon_nesterov", "hint_key": "field.muon_nesterovHint", "target": "merged", "show_if": {"key": "optimizer_type", "eq": MUON_OPTIMIZER_TYPE}, "advanced": True, "doc_slug": "optimizers", "doc_anchor": "muon-options"},
{"key": "muon_ns_steps", "type": "number", "default": 5, "section": "optimizer", "desc_key": "field.muon_ns_steps", "hint_key": "field.muon_ns_stepsHint", "target": "merged", "min": 1, "max": 99, "step": 1, "show_if": {"key": "optimizer_type", "eq": MUON_OPTIMIZER_TYPE}, "advanced": True, "doc_slug": "optimizers", "doc_anchor": "muon-options"},
{"key": "muon_ns_coefficients", "type": "text", "default": "3.4445, -4.775, 2.0315", "section": "optimizer", "desc_key": "field.muon_ns_coefficients", "hint_key": "field.muon_ns_coefficientsHint", "target": "merged", "show_if": {"key": "optimizer_type", "eq": MUON_OPTIMIZER_TYPE}, "advanced": True, "doc_slug": "optimizers", "doc_anchor": "muon-options"},
...
{"key": "save_state", "type": "toggle", "default": False, "section": "save", "desc_key": "field.save_state", "target": "toml", "omit_default": True},
    ...
    {"key": "save_state_on_train_end", "type": "toggle", "default": False, "section": "save", "desc_key": "field.save_state_on_train_end", "hint_key": "field.save_state_on_train_endHint", "target": "toml", "advanced": True, "omit_default": True},
