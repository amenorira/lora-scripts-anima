...
{"key": "network_args_custom", "type": "textarea", "default": "", "section": "network", "desc_key": "field.network_args_custom", "target": "ui", "hint_key": "field.network_args_customHint"},
    # lycoris.kohya 算法选择器
    {"key": "lycoris_algo", "type": "select", "default": "lora", "section": "network", "desc_key": "field.lycoris_algo", "target": "ui", "show_if": {"key": "network_module", "eq": "lycoris.kohya"}, "options": [{"v": "lora", "l": "LoCon (Enhanced LoRA+Conv)", "dk": "opt.lycoris_algo_locon"}, {"v": "loha", "l": "LoHa (Hadamard)", "dk": "opt.lycoris_algo_loha"}, {"v": "lokr", "l": "LoKr (Kronecker)", "dk": "opt.lycoris_algo_lokr"}, {"v": "dylora", "l": "DyLoRA (Dynamic Rank)", "dk": "opt.lycoris_algo_dylora"}, {"v": "glora", "l": "GLoRA (Generalized LoRA)", "dk": "opt.lycoris_algo_glora"}, {"v": "diag-oft", "l": "Diag-OFT (Diagonal Orthogonal FT)", "dk": "opt.lycoris_algo_diagoft"}, {"v": "boft", "l": "Butterfly OFT (Butterfly Orthogonal FT)", "dk": "opt.lycoris_algo_boft"}, {"v": "ia3", "l": "IA³ (Infused Adapter)", "dk": "opt.lycoris_algo_ia3"}]},
