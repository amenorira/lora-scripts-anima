...
window.OPTIMIZER_DEFAULTS = {
  learning_rate: {
    ...
    'Muon': '1e-4',
    'vendor.lora_muon.LoRA_Muon': '0.1',
  ...
  weight_decay: {
    ...
    // Native torch.optim.Muon defaults to 0.1; emit the product default 0
    // explicitly so the trainer does not silently inherit that decay.
    'Muon': 0.1,
    'vendor.lora_muon.LoRA_Muon': 0,
  ...
  inv_sqrt_eps: { 'vendor.lora_muon.LoRA_Muon': '1e-5' },
  inv_sqrt_gamma: { 'vendor.lora_muon.LoRA_Muon': '1.001' },
  gauge_rebalance: { 'vendor.lora_muon.LoRA_Muon': false },
  gauge_rebalance_alpha: { 'vendor.lora_muon.LoRA_Muon': 1.0 },
